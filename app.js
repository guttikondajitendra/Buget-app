var budgetController = (function() {
    ...
    return {
        ...
        calcuateBudget: function() {
            ...
            // calcuate the percentage if income that we spent
...
var UIController = (function() {
 ...
 /* 
 + or - before number exactly 2 decimal points comma separating the thousand 
 2310.4567 --> + 2,310.46
 */
num = Math.abs(num);
num = num.toFixed(2);
...
budgetCtrl.calcuateBudget();
    ...
    // calcuate and update percentage
    updatePercentages();
      }
    };
